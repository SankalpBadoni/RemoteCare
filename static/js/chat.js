...
function appendMessage(name, side, text) {
  ...
  const nameClass =
    side === "right" ? "text-white text-opacity-90" : "text-white";

  let msgHTML = `
    <div class="msg ${side}-msg flex ${
    side === "right" ? "justify-end" : "justify-start"
        ...
        <div class="msg-bubble ${msgBubbleClass} p-4 max-w-xs md:max-w-md shadow-sm relative">
            <div class="msg-info mb-2 flex items-center justify-between">
                ...
                <div class="msg-info-time text-xs opacity-75 ml-2">${formatDate(
                  new Date()
                )}</div>
            </div>
